...
class Config //extends ConfigRepository
{
    ...
    public function has(
        ...
        return $this->config->has("KeepoalaWidget2" . '.' . $key);
    }
    ...
    public function get(
        ...
        $value = $this->config->get("KeepoalaWidget2" . '.' . $key);
    ...
    public function set(
        ...
        $this->config->set("KeepoalaWidget2" . '.' . $key, $value);
    }
    ...
    public function prepend(
        ...
        $this->config->prepend("KeepoalaWidget2" . $key, $value);
    }
    ...
    public function push(
        ...
        $this->config->push("KeepoalaWidget2" . $key, $value);
    }
